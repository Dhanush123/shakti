...
from shakti.utils.constants import PROJECT_ID, GCP_REGION, GCS_BUCKET_NAME, GCP_DATAPROC_CLUSTER, DATAPROC, GCP_DEFAULT_REGION
...
def submit_pyspark_job(spark_job_path, spark_bucket_output_path, **kwargs):
    get_env_creds()
    ...
    gcs_file_upload(DATAPROC, mod_job_path)
